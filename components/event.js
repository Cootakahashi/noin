    ...
    <div className="flex flex-wrap -m-4 grid md:grid-cols-2">
      <div className="p-4 lg:w-full">
        <div className="border h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          ...
          <h1 className="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3 text-center">Meet up</h1>
          <p className="leading-relaxed mb-3 text-left">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
      ...
      <div className="p-4 lg:w-full">
        <div className="border h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
          ...
          <h1 className="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3 text-center">Online web seminar</h1>
          <p className="leading-relaxed mb-3 text-left">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
